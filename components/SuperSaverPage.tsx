...
const SuperSaverPage: React.FC<SuperSaverPageProps> = ({ addToCart, initialConfig }) => {
  ...
  const dogSaverPackages = {
    short: {
      small: [
        { name: 'Full Grooming', sessions: 3, price: '₹3,899', savings: '5.5% Off', color: 'border-orange-200 text-orange-600', validity: '6 months' },
        { name: 'Full Grooming', sessions: 6, price: '₹7,199', savings: '5.9% Off', color: 'border-orange-400 text-orange-700', validity: '12 months' },
        { name: 'Full Grooming', sessions: 12, price: '₹11,199', savings: 'Best Value', color: 'border-[#FF8200] text-[#FF8200]', details: 'Our most comprehensive package. Includes a therapeutic bath with specialized shampoos (anti-tick/flea, anti-rashes, or sensitive skin), deep conditioning, a professional blow-dry, and hair setting. We finish with complete hygiene care for eyes, ears, teeth, and nails.', validity: '16 months' },
        { name: 'Tick & Flea Combo', sessions: 3, price: '₹5,499', savings: 'Combo Saver', color: 'border-red-200 text-red-600', validity: '6 months' },
        { name: 'Medicated Combo', sessions: 3, price: '₹5,999', savings: 'Skin Care Saver', color: 'border-blue-200 text-blue-600', validity: '6 months' },
      ],
      medium: [
        { name: 'Full Grooming', sessions: 3, price: '₹5,099', savings: '5.5% Off', color: 'border-orange-200 text-orange-600', validity: '6 months' },
        { name: 'Full Grooming', sessions: 6, price: '₹9,599', savings: '5.9% Off', color: 'border-orange-400 text-orange-700', validity: '12 months' },
        { name: 'Full Grooming', sessions: 12, price: '₹14,999', savings: 'Best Value', color: 'border-[#FF8200] text-[#FF8200]', details: 'Our most comprehensive package. Includes a therapeutic bath with specialized shampoos (anti-tick/flea, anti-rashes, or sensitive skin), deep conditioning, a professional blow-dry, and hair setting. We finish with complete hygiene care for eyes, ears, teeth, and nails.', validity: '16 months' },
        { name: 'Tick & Flea Combo', sessions: 3, price: '₹7,299', savings: 'Combo Saver', color: 'border-red-200 text-red-600', validity: '6 months' },
        { name: 'Medicated Combo', sessions: 3, price: '₹7,899', savings: 'Skin Care Saver', color: 'border-blue-200 text-blue-600', validity: '6 months' },
      ],
      large: [
        { name: 'Full Grooming', sessions: 3, price: '₹6,399', savings: '5.5% Off', color: 'border-orange-200 text-orange-600', validity: '6 months' },
        { name: 'Full Grooming', sessions: 6, price: '₹11,999', savings: '5.9% Off', color: 'border-orange-400 text-orange-700', validity: '12 months' },
        { name: 'Full Grooming', sessions: 12, price: '₹18,699', savings: 'Best Value', color: 'border-[#FF8200] text-[#FF8200]', details: 'Our most comprehensive package. Includes a therapeutic bath with specialized shampoos (anti-tick/flea, anti-rashes, or sensitive skin), deep conditioning, a professional blow-dry, and hair setting. We finish with complete hygiene care for eyes, ears, teeth, and nails.', validity: '16 months' },
        { name: 'Tick & Flea Combo', sessions: 3, price: '₹8,999', savings: 'Combo Saver', color: 'border-red-200 text-red-600', validity: '6 months' },
        { name: 'Medicated Combo', sessions: 3, price: '₹9,699', savings: 'Skin Care Saver', color: 'border-blue-200 text-blue-600', validity: '6 months' },
      ],
    },
    long: {
      small: [
        { name: 'Full Grooming', sessions: 3, price: '₹5,099', savings: '5.5% Off', color: 'border-green-200 text-green-600', validity: '6 months' },
        { name: 'Full Grooming', sessions: 6, price: '₹9,599', savings: '5.9% Off', color: 'border-green-400 text-green-700', validity: '12 months' },
        { name: 'Full Grooming', sessions: 12, price: '₹14,999', savings: 'Best Value', color: 'border-[#14d220] text-[#14d220]', details: 'Our most comprehensive package. Includes a therapeutic bath with specialized shampoos (anti-tick/flea, anti-rashes, or sensitive skin), deep conditioning, a professional blow-dry, and hair setting. We finish with complete hygiene care for eyes, ears, teeth, and nails.', validity: '16 months' },
        { name: 'Tick & Flea Combo', sessions: 3, price: '₹7,299', savings: 'Combo Saver', color: 'border-red-200 text-red-600', validity: '6 months' },
        { name: 'Medicated Combo', sessions: 3, price: '₹7,899', savings: 'Skin Care Saver', color: 'border-blue-200 text-blue-600', validity: '6 months' },
      ],
      medium: [
        { name: 'Full Grooming', sessions: 3, price: '₹6,399', savings: '5.5% Off', color: 'border-green-200 text-green-600', validity: '6 months' },
        { name: 'Full Grooming', sessions: 6, price: '₹11,999', savings: '5.9% Off', color: 'border-green-400 text-green-700', validity: '12 months' },
        { name: 'Full Grooming', sessions: 12, price: '₹18,699', savings: 'Best Value', color: 'border-[#14d220] text-[#14d220]', details: 'Our most comprehensive package. Includes a therapeutic bath with specialized shampoos (anti-tick/flea, anti-rashes, or sensitive skin), deep conditioning, a professional blow-dry, and hair setting. We finish with complete hygiene care for eyes, ears, teeth, and nails.', validity: '16 months' },
        { name: 'Tick & Flea Combo', sessions: 3, price: '₹8,999', savings: 'Combo Saver', color: 'border-red-200 text-red-600', validity: '6 months' },
        { name: 'Medicated Combo', sessions: 3, price: '₹9,699', savings: 'Skin Care Saver', color: 'border-blue-200 text-blue-600', validity: '6 months' },
      ],
      large: [
        { name: 'Full Grooming', sessions: 3, price: '₹6,999', savings: '5.5% Off', color: 'border-green-200 text-green-600', validity: '6 months' },
        { name: 'Full Grooming', sessions: 6, price: '₹13,199', savings: '5.9% Off', color: 'border-green-400 text-green-700', validity: '12 months' },
        { name: 'Full Grooming', sessions: 12, price: '₹20,599', savings: 'Best Value', color: 'border-[#14d220] text-[#14d220]', details: 'Our most comprehensive package. Includes a therapeutic bath with specialized shampoos (anti-tick/flea, anti-rashes, or sensitive skin), deep conditioning, a professional blow-dry, and hair setting. We finish with complete hygiene care for eyes, ears, teeth, and nails.', validity: '16 months' },
        { name: 'Tick & Flea Combo', sessions: 3, price: '₹9,999', savings: 'Combo Saver', color: 'border-red-200 text-red-600', validity: '6 months' },
        { name: 'Medicated Combo', sessions: 3, price: '₹10,799', savings: 'Skin Care Saver', color: 'border-blue-200 text-blue-600', validity: '6 months' },
      ],
    }
  };
  ...
  const catSaverPackages = {
    short: [
      { sessions: 3, price: '₹3899', savings: 'Basic Saver', color: 'border-orange-200 text-orange-600', validity: '6 months' },
      { sessions: 6, price: '₹7199', savings: 'Value Bundle', color: 'border-orange-400 text-orange-700', validity: '12 months' },
      { sessions: 12, price: '₹11199', savings: 'Premium Saver', color: 'border-[#FF8200] text-[#FF8200]', validity: '16 months' },
      { name: 'Tick & Flea Combo', sessions: 3, price: '₹5,499', savings: 'Combo Saver', color: 'border-red-200 text-red-600', validity: '6 months' },
    ],
    long: [
      { sessions: 3, price: '₹5099', savings: 'Basic Saver', color: 'border-green-200 text-green-600', validity: '6 months' },
      { sessions: 6, price: '₹9599', savings: 'Value Bundle', color: 'border-green-400 text-green-700', validity: '12 months' },
      { sessions: 12, price: '₹16799', savings: 'Premium Saver', color: 'border-[#14d220] text-[#14d220]', validity: '16 months' },
      { name: 'Tick & Flea Combo', sessions: 3, price: '₹7,299', savings: 'Combo Saver', color: 'border-red-200 text-red-600', validity: '6 months' },
    ]
  };
